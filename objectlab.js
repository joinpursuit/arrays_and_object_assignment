...
for (let movie of movieStatus) {
    if (movie["watchStatus"]) {
        console.log("10) ", `You already watched ${movie["title"]} directed by ${movie["director"]}.`);
    } else {
        console.log("10) ", `You still need to watch ${movie["title"]} directed by ${movie["director"]}.`);
    }
}
