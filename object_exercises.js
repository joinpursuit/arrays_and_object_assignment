...
//Write code that logs whether or not `cat` has the property 'texture'.
// if (cat.hasOwnProperty("texture")){
//   console.log("texture " + cat.texture);
// } else {
//   console.log("cat object does not contain a texture key")
// }
...
//
// console.log(p1 === p2)
// It will return false because in order to return true, the object
//cannot be compared on values but by references```
...
// ```
//
//a. Write a code block that takes an object variable and stores the
//*keys* in an array.  Then log the array.
...
//     ]
// ```
// a. Create an array of strings called `firstNames` that contains only
//the values for `“firstName”` from each object.
...
// ```
//
// a) Write code to to print the name and total amount
//deposited of the person who received the most money.
//let sum = 0;
let depositAmt = Object.keys(deposits)
for (let k = 0; k < deposits.length; k++) {
  
}
  console.log(depositAmt)

// b) Create an array called `stolenCents`,
//iterate over deposits for each person and steal their cents! ...
//like Office Space or Superman 3. Calculate the decimal part of each value,
//add it to the `stolenCents` array and round down the value in the original
//object.
//
...
//It should have the following properties: `name`, `servings`,
// and `ingredients`
//(an array).
...
//   console.log("name: " + recipe[i].name)
//   console.log("servings: " + recipe[i].servings)
//   console.log("ingredients: " + recipe[i].ingredients)
// }
//
// ## // console.log("----------question 10---------)
// * Create an array of films, where each film has the following
//properties: title, director, and a boolean indicating if you started watching
//it.
// * Create a code block that iterates over the array and
//logs whether the film was watched or not. Examples:
//
...
//   let movieMarvel= marvelMovies[i]
//   let movieTitle = marvelMovies[i].title
//   let movieDirector = marvelMovies[i].director
//   let movieWatched = marvelMovies[i].watch
//     if (movieWatched === true) {
//       console.log("I already watched " + movieTitle + " directed by " + movieDirector)
//     } else {
//     console.log("I still need to watch " + movieTitle + " by director " + movieDirector)
//   }
//   }
...
// candid world.
// `
// declarationOfIndependence.split(" ,")
