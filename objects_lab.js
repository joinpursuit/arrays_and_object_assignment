...
console.log('It will log as false, because they are two different objects.');
...
//   lastname: 'garcia',
// };
// //console.log(aransa.length);// does not work
// for (let i = 0; i < aransa.length; i++) {
//
// }
//
// console.log(Object.keys(aransa).length);
// let counter = 0;
// for (let key in aransa) {
//   counter += 1;
// }
...
let firstNames = [];
for (let i = 0; i < i.people; i++) {
  console.log(people[i].FirstNames);
}
...
let biggest = 0; // this one will log the most frequent
let nextbiggest = 0;
let counter = {};
