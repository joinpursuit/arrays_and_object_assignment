...
// console.log(p1 === p2)
// ```
console.log("My Answer: The code will log 'false' because they are each seperate objects and stand on their own, therefore they aren't going to be equivalent to one another.")
...
let englishNumbers = {1: "one", 2: "two", 3: "three", 4: "four", 5: "five"}
let arr3 = []
for (let key in englishNumbers){
console.log(arr3.push(key))
}
console.log("The object 'englishNumbers' has " + arr3.length + " properties.");
